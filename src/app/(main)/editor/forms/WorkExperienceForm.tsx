        ...
        <div className="max-w-xl mx-auto space-y-6">
            <div className="space-y-1.5 text-center">
                ...
                <p className="text-sm text-muted-foreground ">
                    Add aas many work experiences as you like
                </p>
            </div>
            <Form {...form}>
...
function WorkExperienceItem({ id, form, index, remove }: WorkExperienceItemProps) {
    ...
    return (
        <div className={cn("space-y-3  rounded-md border bg-background p-3", isDragging && "relative z-50 cursor-grab shadow-xl")} ref={setNodeRef} style={{ transform: CSS.Transform.toString(transform), transition, }}>
